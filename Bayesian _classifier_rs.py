...
iris[0] = BayseClassifier(len(setosa), setosa)
# サンプルirisversicolorをベイズ識別器に入力
iris[1] = BayseClassifier(len(versicolor), versicolor)
# サンプルirisviriginicaをベイズ識別器に入力
iris[2] = BayseClassifier(len(viriginica), viriginica)
